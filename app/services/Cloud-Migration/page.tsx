...
export default function CloudeMigration() {
  const processSteps = [
    {
      step: "01",
      ...
      <div className="px-4 sm:px-6 lg:px-12 py-4 border-b border-white/10">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center space-x-2 text-sm text-white/60">
            ...
            <span>/</span>
            <span className="text-orange-500">Cloud Migration & Operations</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-balance">
                Cloud Migration <span className="text-orange-500">& Operations</span>
              </h1>
            ...
            <div className="relative">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                <h3 className="text-2xl font-bold mb-6">Cloud Migration Capabilities</h3>
